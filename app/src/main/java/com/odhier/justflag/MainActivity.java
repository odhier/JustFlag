...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_flag = (ImageView) findViewById(R.id.imageView);
        ...
        b_answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(b_answer1.getText().toString().equalsIgnoreCase(list.get(turn-1).getName())){
                    Toast.makeText(MainActivity.this, "Benar gan", Toast.LENGTH_SHORT).show();

                    if(turn < list.size()){
                        turn++;
                        newQuestion(turn);
                    }else{
                        Toast.makeText(MainActivity.this, "Selamat Anda Menyelesaikan Game", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(MainActivity.this, "Salah bro!", Toast.LENGTH_SHORT).show();
                    Toast.makeText(MainActivity.this, "Kamu gagal", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
